...
<h5 class="title-normal text-center" id="respond_com"><i class="fa fa-commenting"></i> 发表评论 <a id="cancel-comment-reply-link" href="javascript:;"  class="btn btn-sm btn-warning" style="display:none;"><?php echo __('取消回复', 'ui_boxmoe_com') ?></a> </h5> 
<form id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">                      
<?php if ( is_user_logged_in() ) { ?>
<div class="row justify-content-center mb10">
<div class="col-md-6 text-center">
<div class="badge badge-success">
您已登录:<?php echo $user_identity; ?>  <a href="<?php echo wp_logout_url(get_permalink()); ?>" >[ 退出登录 &raquo; ]</a></div>
</div>
</div>
<?php }?>									
...
<?php endif; ?> 
 <?php if ( !$user_ID && !is_user_logged_in() ): ?>		
                                          <div class="row" id="comment-author-info">
												...
												<input type="text" name="author" id="author" class="form-control" value="<?php echo $comment_author; ?>" placeholder="<?php echo __('昵称 *', 'ui_boxmoe_com') ?>" tabindex="1">
                                                </div>
                                                </div>
												</div>
                                          <div class="col-md-4">
												...
												<input type="email" name="email" id="email" class="form-control" value="<?php echo $comment_author_email; ?>" placeholder="<?php echo __('邮箱 *', 'ui_boxmoe_com') ?>"  tabindex="2" />
                                                </div>
                                                </div>
												</div>
                                          <div class="col-md-4">
												...
												<input type="text" name="url" id="url" class="form-control" value="<?php echo $comment_author_url; ?>" placeholder="<?php echo __('网址', 'ui_boxmoe_com') ?>" size="22" tabindex="3" />	
                                                </div>
                                                </div>
												</div>
										   </div>
