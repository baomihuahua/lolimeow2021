...
//==========================================================================================
	...
	$options[] = array(
		...
		'desc' => __('开启', 'ui_boxmoe_com')); 
	$options[] = array(
			'name' => __('（7-1）自定义显示文字', 'ui_boxmoe_com'),
			'id' => 'lolijumptext',
			'std' => '回到顶部',
			'class' => 'hidden mini',
			'instructions' => __('（鼠标放在小萝莉图上，头顶显示的文字）', 'ui_boxmoe_com'),
			'type' => 'text');		
	$options[] = array(
		'name' => __('（7-2）选择前端小萝莉展现形象', 'ui_boxmoe_com'),
		'id' => 'lolijumpsister',
		'type' => "radio",
		'std' => 'lolisister1',
		'class' => 'hidden',
	...
	$options[] = array(
		...
		'id' => 'footer_seo',
		'std' => '<ul class="nav nav-footer justify-content-center mt10"><li class="nav-item"><a href="'.site_url('/sitemap.xml').'" class="nav-link" target="_blank">'.__('网站地图', 'ui_boxmoe_com').'</a></li></ul>'."\n",
		'instructions' => __('（网站地图可自行使用sitemap插件自动生成）', 'ui_boxmoe_com'),
		'settings' => array('rows' => 3),
		'type' => 'textarea');
	$options[] = array(
		'name' => __('（10）网站底部版权后自定义信息', 'ui_boxmoe_com'),
		'id' => 'footer_info',
		'std' => '| 本站使用Wordpress创作'."\n",
		'settings' => array('rows' => 3),
		'type' => 'textarea');	
    ...
    $options[] = array(
		...
		'instructions' => __('（底部第三方流量数据统计代码,默认主题隐藏统计代码，具体查看前端源码）', 'ui_boxmoe_com'),
		'id' => 'trackcode',
		'std' => '统计代码',
		'settings' => array('rows' => 3),
		'type' => 'textarea');		
	$options[] = array(
		...
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启统计代码隐藏（开启后底部统计代码隐藏不显示，但不影响统计）', 'ui_boxmoe_com'));
	$options[] = array(
		'name' => __('（7-1）自定义显示文字'),
		'instructions' => __('（鼠标放在小萝莉图上，头顶显示的文字）', 'ui_boxmoe_com'),
		'id' => 'lolijump_font',
...
//==========================================================================================
	...
	$options[] = array(
		...
		'desc' => __('开启', 'ui_boxmoe_com'));
	$options[] = array(
		'name' => __('博客文章列表风格切换', 'ui_boxmoe_com'),
		'id' => 'blog_list_style',
		'std' => "list_style_1",
		'type' => "radio",
		'options' => array(
			'list_style_1' => __('默认标准', 'ui_boxmoe_com'),
			'list_style_2' => __('背景列表', 'ui_boxmoe_com'),
			'list_style_3' => __('无图列表', 'ui_boxmoe_com')
		));	
	$options[] = array(
		'name' => __('文章列表边框和阴影切换', 'ui_boxmoe_com'),
		'id' => 'blog_border',
		'std' => "border1",
		'type' => "radio",
		'options' => array(
			'border1' => __('边框形式', 'ui_boxmoe_com'),
			'border2' => __('阴影形式', 'ui_boxmoe_com')
		));
	$options[] = array(
	...
	$options[] = array(
		...
		'type' => 'text');	
	$options[] = array(
		'name' => __('文章代码高亮', 'ui_boxmoe_com'),
		'instructions' => __('（如果你有用插件就不要打开）', 'ui_boxmoe_com'),
		'id' => 'code_light_on',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启', 'ui_boxmoe_com'));		
